...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center overflow-hidden py-20">
      ...
      >
        <div className="flex items-center justify-center pointer-events-auto shadow-md">
          <button
          ...
          >
            ...
            {/* Inner Content */}
            <div className="relative z-10 flex  items-center gap-3 px-8 py-4 rounded-[14px] bg-background/90 backdrop-blur-xl transition-all duration-300 ease-out group-hover:bg-background/70 border border-white/5">
        ...
        <div className="flex flex-col items-center text-center px-6">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              •{" "}
              <span className="text-foreground font-bold">Problem Solver</span>
            </motion.p>
        ...
        <div className="flex justify-between items-end px-6 md:px-16 mt-auto">
          ...
          >
            ...
            <div className="text-center">
              <span className="block text-[10px] font-mono font-bold uppercase tracking-widest text-foreground">
                Based in Mumbai
              </span>
              <span className="block text-[9px] text-muted-foreground uppercase tracking-[0.2em]">
                Maharashtra, INDIA
              </span>
            </div>
          </motion.div>
